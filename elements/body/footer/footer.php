<footer>
        ...
        <div class="row foot_row2">
            ...
            <div class="col-sm-4">
                ...
                <ul class="list-unstyled col-2">
                    <li>
                        <img width="16" height="16" alt="Đang truy cập" src="assets/images/users.png">
                        Đang truy cập : <strong>24</strong>
                    </li>
                    <li>
                        <img width="16" height="16" alt="Hôm nay" src="assets/images/today.png">
                        Hôm nay : <strong>33</strong>
                    </li>
                    <li>
                        <img width="16" height="16" alt="Tháng hiện tại" src="assets/images/month.png">
                        Tháng hiện tại : <strong>2089</strong>
                    </li>
                    <li>
                        <img width="16" height="16" alt="Tổng lượt truy cập" src="assets/images/hits.png">
    ...
    <div class="author">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <span><small>Copyright 2017 | Bản quyền thuộc Ôỉ xanh</small></span>
                </div>
            </div>
        </div>
    </div>
